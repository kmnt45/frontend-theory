...
## 16. Какие методы жизненного цикла не воспроизводятся в функциональных компонентах?
...
## 35. Что такое обратный поток данных в React?
...
## 38. Что такое предохранители (Error Boundaries)?
