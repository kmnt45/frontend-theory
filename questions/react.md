...
## 9. Разница между элементом и компонентом?
...
React полностью управляет значением элемента — оно хранится в state, а изменения происходят через setState / useState.
...
## 13. Стадии жизненного цикла компонента в React?
...
## 14. Методы жизненного цикла компонента в React?
...
## 19. Что такое синтетические события в React?
...
## 22. Разница между компонентом и контейнером?
...
## 25. Что такое «опрос» (Polling)? Как его реализовать в React?
...
## 27. Что такое инверсия наследования?
...
## 28. Как в React реализовать двустороннее связывание данных?
...
## 29. Разница между классовым и функциональным компонентами?
...
## 30. Что такое поднятие состояния вверх (Lifting State Up)?
...
## 31. Что такое обратный поток данных в React?
...
## 35. Является ли React реактивным?
...
## 36. Что такое батчинг ререндеров?
