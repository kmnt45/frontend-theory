...
## 6. Политика одинакового источника (same-origin policy)
...
## 9. Методы для хранения данных в браузере?
...
## 10. Как поддерживать постоянное соединение?
...
## 11. Архитектура проекта и ее отличие от структуры. Какие архитектуры использовал?
...
## 13. Зачем нужен ESLint, настройка и плагины?
...
## 14. Приватные вкладки (по хранилищам), отличие от обычных.
...
## 16. Браузерное кеширование (статики, запросов, на уровне браузеров, без стейт менеджеров). Заголовки кеш контрол.
